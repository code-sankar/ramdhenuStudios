...
import { PROJECTS_ARE_PLACEHOLDER, services } from "../data/services";
import { whatsappLink } from "../data/site";

/**
 * SERVICE PAGE — the template every /services/<slug>/ page renders.
 *
 ...
 * section is now an index that points here.
 */
export default function ServicePage({ service }) {
  ...
  return (
    <>
      <a href="#service-body" className="skip-link">
        Skip to content
      </a>
      <Header />
          ...
          <div className="shell relative">
            <nav aria-label="Breadcrumb" className="mb-8">
              <ol className="flex list-none flex-wrap items-center gap-2 p-0 text-[12px] tracking-[0.08em] text-paper/55 uppercase">
                <li>
                  <a href="/" className="no-underline hover:text-steel-300">
                    Home
                  </a>
                </li>
                <li aria-hidden="true">/</li>
                <li>
                  <a href="/#services" className="no-underline hover:text-steel-300">
                    Services
                  </a>
                </li>
                <li aria-hidden="true">/</li>
